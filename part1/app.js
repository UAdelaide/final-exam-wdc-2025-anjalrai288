    ...
    try {
        ...
        try {
            ...
            await db.execute(`
                ...
                ('ghjb456', 'ghjb@example.com', 'hashed109', 'owner'),
                ('dcs', 'dcs@example.com', 'hashed202', 'walker');
            `);
            ...
            await db.execute(`
                ...
                ((SELECT user_id FROM Users WHERE username = 'carol123' AND role = 'owner'), 'Rocky', 'large'),
