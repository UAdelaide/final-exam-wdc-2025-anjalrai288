    ...
    try {
        ...
        try {
            ...
            await db.execute(`
                ...
                ((SELECT dog_id FROM Dogs WHERE name = 'Rocky' AND owner_id = (SELECT user_id FROM Users WHERE username = 'carol123')), '2025-06-11 10:00:00', 60, 'City Park', 'open'),
                ((SELECT dog_id FROM Dogs WHERE name = 'Daisy' AND owner_id = (SELECT user_id FROM Users WHERE username = 'alice123')), '2025-06-12 07:45:00', 25, 'Riverfront Trail', 'open'),
                ((SELECT dog_id FROM Dogs WHERE name = 'Gus' AND owner_id = (SELECT user_id FROM Users WHERE username = 'carol123')), '2025-06-13 18:00:00', 40, 'Hillside Path', 'cancelled');
            `);
